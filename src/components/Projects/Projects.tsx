		...
		<div className={styles.Content}>
			<div className={styles.Screen}>
				...
				<div className={styles.Projects}>
					<motion.a href='http://tonraffles.app/lock' onMouseEnter={() => MakeClear('Block1')} onMouseLeave={() => MakeBlur('Block1')} variants={fadeIn("right", "spring", 0, 1)} className={classNames(styles.Block, styles.Block1, styles.cursor_pointer)}>
					...
					<motion.a href='https://tonraffles.app/nft/launchpad' onMouseEnter={() => MakeClear('Block2')} onMouseLeave={() => MakeBlur('Block2')} variants={fadeIn("left", "spring", 0.5, 1)} className={classNames(styles.Block, styles.Block2, styles.cursor_pointer)}>
					...
					<motion.a href='https://testnet.ooia.art' onMouseEnter={() => MakeClear('Block3')} onMouseLeave={() => MakeBlur('Block3')} variants={fadeIn("down", "spring", 0.25, 1)}  className={classNames(styles.Block, styles.Block3, styles.cursor_pointer)}>
					...
					<motion.a href='https://www.monaki.life' onMouseEnter={() => MakeClear('Block4')} onMouseLeave={() => MakeBlur('Block4')} variants={fadeIn("down", "spring", 0.25, 1)}  className={classNames(styles.Block, styles.Block4, styles.cursor_pointer)}>
